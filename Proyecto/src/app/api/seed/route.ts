...
export async function POST() {
  try {
    ...
    // Create Espacios Comunes
    await db.espacioComun.createMany({
      data: [
        { codigo: 'ESP-001', nombre: 'Quincho 1', tipo: 'Quincho', capacidad: 50, precioHora: 15000, precioDia: 80000, requierePago: true, activo: true },
        { codigo: 'ESP-002', nombre: 'Quincho 2', tipo: 'Quincho', capacidad: 40, precioHora: 12000, precioDia: 65000, requierePago: true, activo: true },
        { codigo: 'ESP-003', nombre: 'Quincho 3', tipo: 'Quincho', capacidad: 30, precioHora: 10000, precioDia: 50000, requierePago: true, activo: true },
        { codigo: 'ESP-004', nombre: 'Cancha Futbolito', tipo: 'Cancha Futbolito', capacidad: 20, precioHora: 8000, precioDia: 40000, requierePago: true, activo: true },
        { codigo: 'ESP-005', nombre: 'Multicancha', tipo: 'Multicancha', capacidad: 30, precioHora: 5000, precioDia: 25000, requierePago: true, activo: true },
        { codigo: 'ESP-006', nombre: 'Club House', tipo: 'Club House', capacidad: 100, precioHora: 25000, precioDia: 150000, requierePago: true, activo: true },
        { codigo: 'ESP-007', nombre: 'Jacuzzi', tipo: 'Jacuzzi', capacidad: 6, precioHora: 5000, precioDia: 20000, requierePago: true, activo: true },
        { codigo: 'ESP-008', nombre: 'Sauna', tipo: 'Sauna', capacidad: 8, precioHora: 5000, precioDia: 20000, requierePago: true, activo: true },
      ]
    })
    
    // Create Estacionamientos (12 total)
    ...
    for (let i = 1; i <= 12; i++) {
      estacionamientos.push({
        codigo: `ESP-EST-${String(i).padStart(2, '0')}`,
    ...
    await db.espacioComun.createMany({ data: estacionamientos })
