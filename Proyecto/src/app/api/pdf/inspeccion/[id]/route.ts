...
<body>
  <div class="header">
    <div class="logo-section">
      <div class="logo">
        <div class="logo-text">SERVICIOS<br>INTEGRALES</div>
      </div>
      <div>
        <div class="company-name">Servicios Integrales</div>
        <div class="company-sub">Gestión Inmobiliaria</div>
      </div>
    </div>
  ...
  <div class="footer">
    ...
    <span>Servicios Integrales - Sistema de Gestión</span>
  </div>
